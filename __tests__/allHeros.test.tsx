...
describe('allHeros', () => {
  const MockHeros = [
    {
      ...
      urls: [
        {
          type: 'detail',
          url: 'http://marvel.com/characters/74/3-d_man?utm_campaign=apiRef&utm_source=fdeff499d2c6279f1f30a22ff9788a56',
        },
        {
          type: 'wiki',
          url: 'http://marvel.com/universe/3-D_Man_(Chandler)?utm_campaign=apiRef&utm_source=fdeff499d2c6279f1f30a22ff9788a56',
        },
        {
          type: 'comiclink',
          url: 'http://marvel.com/comics/characters/1011334/3-d_man?utm_campaign=apiRef&utm_source=fdeff499d2c6279f1f30a22ff9788a56',
        },
      ],
    },
    {
      ...
      urls: [
        {
          type: 'detail',
          url: 'http://marvel.com/characters/76/a-bomb?utm_campaign=apiRef&utm_source=fdeff499d2c6279f1f30a22ff9788a56',
        },
        {
          type: 'comiclink',
          url: 'http://marvel.com/comics/characters/1017100/a-bomb_has?utm_campaign=apiRef&utm_source=fdeff499d2c6279f1f30a22ff9788a56',
        },
      ],
    },
    {
      ...
      urls: [
        {
          type: 'detail',
          url: 'http://marvel.com/characters/77/aim.?utm_campaign=apiRef&utm_source=fdeff499d2c6279f1f30a22ff9788a56',
        },
        {
          type: 'wiki',
          url: 'http://marvel.com/universe/A.I.M.?utm_campaign=apiRef&utm_source=fdeff499d2c6279f1f30a22ff9788a56',
        },
        {
          type: 'comiclink',
          url: 'http://marvel.com/comics/characters/1009144/aim.?utm_campaign=apiRef&utm_source=fdeff499d2c6279f1f30a22ff9788a56',
        },
      ],
    },
  ];
  ...
  it('this should get an array using getStatic props from SS', async () => {
    ...
    const text = screen.getByText('MARVEL HEROES');

    expect(text).toBeInTheDocument();
  });

  it('this shoul retorn an image', () => {
    render(<AllHeros heros={MockHeros} />);
